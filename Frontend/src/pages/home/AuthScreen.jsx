...
const AuthScreen = () => {
    ...
    const navigate = useNavigate(); //kisi bhi page se kisi dure page pe navigate karsakte hai navigate hook use karke

//when clicked on submit navigate to the signup page, plus add the email to the sigup page url section.
...
<header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
    ...
    <div className='h-2 w-full bg-[#232323]' aria-hidden='true' />
        ...
        <div className='h-2 w-full bg-[#232323]' aria-hidden='true' />
            ...
            <p className='text-lg md:text-xl'>
              Send kids on advantages with their favorite characters in a space made just for them-free
